...
# Private subnets - one per AZ, hosts the EC2 instances
...
# Single NAT gateway to keep cost down. For prod resilience, switch to
# count = length(var.azs) and give each private route table its own NAT.
